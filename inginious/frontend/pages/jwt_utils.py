...
def decode_jwt(token):
    ...
    """
    current_secret = current_app.config["API_JWT_SECRET"]
    old_secrets = current_app.config["API_JWT_OLD_SECRETS"]
    secrets = [current_secret] + old_secrets
    ...
    raise last_error or jwt.InvalidTokenError("No matching secret found")
